                ...
                <el-form-item style="width: 100%">
                  <el-row type="flex">
                    <el-popover placement="bottom" v-model=" form.extraset " style="text-align: center">
                      <el-row><el-checkbox v-model=" form.new_name " label="Clash新字段"></el-checkbox></el-row>
                      <el-row><el-checkbox v-model=" form.emoji " label="Emoji"></el-checkbox></el-row>
                      <el-row><el-checkbox v-model=" form.udp " label="启用 UDP"></el-checkbox></el-row>
                      ...
                      <el-row><el-checkbox v-model=" form.tfo " label="TCP Fast Open"></el-checkbox></el-row>
                      <el-row><el-checkbox v-model=" form.scv " label="Skip Cert Verify"></el-checkbox></el-row>
                      <el-row><el-checkbox v-model=" form.nodeList " label="输出为 Node List"></el-checkbox></el-row>
                    ...
                    <el-popover placement="bottom" v-model=" form.rule " style="text-align: center">
                      ...
                      <el-row><el-checkbox v-model=" form.classic " label="Classic Rule Provider"></el-checkbox></el-row>
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "sub.firefly-lm.workers.dev": "https://sub.firefly-lm.workers.dev/sub?",
        },
        backendOptions: [
